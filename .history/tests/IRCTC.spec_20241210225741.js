...
//Click the Proceed button
await page.locator('[class="ui-button-icon-left ui-clickable pi pi-check"]').isVisible().click();
await page.waitForTimeout(15000);
...
await page.locator('[class="search_btn train_Search"]', { hasText: 'Search' }).click();
const ErrMessage = await page.locator('[class="ui-toast-detail ng-tns-c16-15"]', { timeout: 10000 });
await expect(ErrMessage).toBeVisible();
await expect(ErrMessage).toHaveText('Please submit correct input');
