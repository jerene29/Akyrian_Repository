...
// Now you can interact with the new tab (newPage)
await newPage3.waitForLoadState(); // Wait until the new page loads
// You can now perform actions on the new page, like:
console.log(await newPage3.title())
...
// Now you can interact with the new tab (newPage)
await newPage4.waitForLoadState();
console.log(await newPage4.title())
