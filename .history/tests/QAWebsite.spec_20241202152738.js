...
await expect(page).toHaveURL('https://www.qaoncloud.com/e-commerce-testing-services', { timeout: 30000 });
//Click   Artificial Intelligence
await page.locator('.navbar-nav > li:nth-of-type(3) > .nav-link', { timeout: 40000 }).click();

await page.locator('a[href="https://www.qaoncloud.com/ai-testing-services"]', { timeout: 40000 }).click();
await expect(page).toHaveURL('https://www.qaoncloud.com/ai-testing-services', { timeout: 30000 });
//Click Insights Link
