...
await expect(page.locator('[class="bpdp_list_title"]')).toHaveText('BOARDING POINT', { exact: false });
await expect(page.locator('[class="bpdp_list_title"]')).toHaveText('DROPPING POINT');
//Click Review
