...
page.locator(".closeBtn > [_ngcontent-ntt-c69]").click() 
...
page.locator(".ui-toast-close-icon").click() 

//To verify the Book Ticket details section with invalid data
//Verify the 'From' field textbox
await page.waitForSelector("[aria-controls='pr_id_11_list']", { state: 'visible' });

// Optionally click to focus the input field
await page.click("[aria-controls='pr_id_11_list']");

// Now fill in the text
await page.fill("[aria-controls='pr_id_11_list']", 'cvvv');
await page.waitForSelector("[aria-controls='pr_id_12_list']", { state: 'visible' });

// Optionally click to focus the input field
await page.click("[aria-controls='pr_id_12_list']");

// Now fill in the text
await page.fill("[aria-controls='pr_id_12list']", 'cvvv');//Verify the 'To' field textbox
//Verify the 'Date' field with datepicker[
await page.locator('[class="ng-tns-c58-10 ui-inputtext ui-widget ui-state-default ui-corner-all ng-star-inserted"]').click()
