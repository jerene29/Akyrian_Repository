...
const [newPage1] = await Promise.all([
  page.context().waitForEvent('page'), // This waits for the new tab
  page.locator('[class="search_btn"][label="PNR STATUS"]').click() // Click the button
]);
...
await expect(page).toHaveURL('https://www.indianrail.gov.in/enquiry/PNR/PnrEnquiry.html?locale=en', { timeout: 60000 });
