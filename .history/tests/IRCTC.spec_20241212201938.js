...
//To verify the Book Ticket details section with valid data
 //Verify the 'From' field textbox
 await page.locator('[class="ui-menuitem-text ng-star-inserted"]', { hasText: ' THIRUVARUR JN - TVR ' }).click();
 ...
 //Verify the 'To' field textbox
 await page.locator('[class="ui-menuitem-text ng-star-inserted"]', { hasText: ' ➨ CHENNAI EGMORE - MS ' }).click();
