...
// Optionally click to focus the input field
await page.click('[class="ng-tns-c57-30ui-inputtext ui-widget ui-state-default ui-corner-all ui-autocomplete-input ng-star-inserted"]');

// Now fill in the text
await page.fill('[class="ng-tns-c57-30ui-inputtext ui-widget ui-state-default ui-corner-all ui-autocomplete-input ng-star-inserted"]', 'cvvv');//Verify the 'To' field textbox
await page.click('[class="col-xs-12 loginhead hidden-xs"]');
...
//To verify the Book Ticket details section with valid data
 //Verify the 'From' field textbox
 await page.fill('[class="ng-tns-c57-29 ui-inputtext ui-widget ui-state-default ui-corner-all ui-autocomplete-input ng-star-inserted"]', 'Thiruvarur');
 await page.click('[class="col-xs-12 loginhead hidden-xs"]');

 //Verify the 'To' field textbox
 await page.fill('[class="ng-tns-c57-30 ui-inputtext ui-widget ui-state-default ui-corner-all ui-autocomplete-input ng-star-inserted"]', 'Chennai');
 await page.click('[class="col-xs-12 loginhead hidden-xs"]');
