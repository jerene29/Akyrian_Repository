...
test('Login to the Portal and login as Source Capture User',async ({ page }) => {
    ...
    await page.locator('#cm2bkvinn0ag5vx8ae9kmvs0b-selectable-patient').waitFor({ state: 'visible' }, { timeout: 100000 });
...
await page.locator('[data-cy="visit-cm31qz0990dhkigpbpkpgy2p5"]')
    ...
    await page.locator('#cy-tabsource').click(); // 60 seconds timeout
...
await page.locator("[data-cy='capture-action-cm2n696qj08n8zdk3hgiru340'] > .question-card-action-menu-icon").click();
