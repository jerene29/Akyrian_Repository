...
await page.locator('a[href="https://www.qaoncloud.com/event-management-software-testing-services"]', { timeout: 40000 }).click();
await expect(page).toHaveURL('https://www.qaoncloud.com/event-management-software-testing-services', { timeout: 40000 });

//Click   E-Commerce
await page.locator('.navbar-nav > li:nth-of-type(3) > .nav-link', { timeout: 40000 }).click();

await page.locator('a[href="https://www.qaoncloud.com/e-commerce-testing-services"]', { timeout: 40000 }).click();
await expect(page).toHaveURL('https://www.qaoncloud.com/e-commerce-testing-services', { timeout: 40000 });
//Click   Artificial Intelligence
await page.locator('.navbar-nav > li:nth-of-type(3) > .nav-link', { timeout: 40000 }).click();

await page.locator('a[href="https://www.qaoncloud.com/ai-testing-services"]', { timeout: 40000 }).click();
await expect(page).toHaveURL('https://www.qaoncloud.com/ai-testing-services', { timeout: 50000 });
//Click Insights Link

await page.locator('.navbar-nav > li:nth-of-type(4) > .nav-link', { timeout: 40000 }).click();
//Click  Blogs
await page.locator('a[href="https://www.qaoncloud.com/blog-trending-posts"]', { timeout: 40000 }).click();
await expect(page).toHaveURL('https://www.qaoncloud.com/blog-trending-posts', { timeout: 30000 });
//Click Casestudies
await page.locator('.navbar-nav > li:nth-of-type(4) > .nav-link', { timeout: 40000 }).click();

await page.locator('a[href="https://www.qaoncloud.com/case-study"]', { timeout: 40000 }).click();
await expect(page).toHaveURL('https://www.qaoncloud.com/case-study', { timeout: 30000 });
//Click FAQs
await page.locator('.navbar-nav > li:nth-of-type(4) > .nav-link', { timeout: 40000 }).click();

await page.locator('a[href="https://www.qaoncloud.com/faq"]', { timeout: 40000 }).click();
await expect(page).toHaveURL('https://www.qaoncloud.com/faq', { timeout: 30000 });
//Click Testimonials
await page.locator('.show.nav-link', { timeout: 40000 }).click();

await page.locator('a[href="https://www.qaoncloud.com/testimonial"]', { timeout: 40000 }).click();
await expect(page).toHaveURL('https://www.qaoncloud.com/testimonial', { timeout: 30000 });
})