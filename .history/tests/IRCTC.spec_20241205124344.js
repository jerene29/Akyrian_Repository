...
test.only('Login_TC001: Check the Login button', async ({ page }) => {
    ...
    await page.locator("[placeholder='User Name']").isVisible().toHaveText("FORGOT ACCOUNT DETAILS?");
    await page.locator("[placeholder='Password']").isVisible().toHaveText("FORGOT ACCOUNT DETAILS?");
