...
await page.locator('button:has-text("SIGN IN")').click()
    ...
    await page.locator('#p-highlighted-option > [_ngcontent-bgm-c67]').click();
...
await page.locator('#p-highlighted-option').click();
//Verify the 'Date' field with datepicker
await page.fill('[class="ng-tns-c58-10 ui-inputtext ui-widget ui-state-default ui-corner-all ng-star-inserted"]', '25/12/2024');
await page.locator('[class="ui-state-default ng-tns-c58-10 ui-state-active ng-star-inserted"]').click();
