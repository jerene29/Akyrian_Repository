...
import { IRCTCPage } from '../pages/IRCTC';
/*
...
test('BookTicketDetails_TC001: To verify the Book Ticket details section ', async ({ page }) => {
    await page.goto('https://www.irctc.co.in/nget/train-search', { timeout: 30000 });
    await page.locator('[class="h_menu_drop_button hidden-xs"]').click()
    await page.locator('[class="search_btn"]').nth(1).click()
    await page.locator("[placeholder='User Name']", '', { timeout: 10000 })
...
//Click the Proceed button
await page.locator('[class="ui-button-text ui-clickable"]', { hasText: 'OK' }).click();
...
await page.click('[class="ng-tns-c57-28 ui-inputtext ui-widget ui-state-default ui-corner-all ui-autocomplete-input ng-star-inserted"]');

// Now fill in the text
await page.fill('[class="ng-tns-c57-28 ui-inputtext ui-widget ui-state-default ui-corner-all ui-autocomplete-input ng-star-inserted"]', 'cvvv');
...
// Now fill in the text
await page.fill('[class="ng-tns-c57-29 ui-inputtext ui-widget ui-state-default ui-corner-all ui-autocomplete-input ng-star-inserted"]', 'cvvv');//Verify the 'To' field textbox
await page.click('[class="col-xs-12 loginhead hidden-xs"]');

//Verify the 'Date' field with datepicker[
await page.locator('[class="ng-tns-c58-30 ui-inputtext ui-widget ui-state-default ui-corner-all ng-star-inserted"]').click()

await page.click('.ui-state-default.ng-tns-c58-30.ng-star-inserted >> text=25');
//Verify the 'Classes' dropdown field 
await page.locator('[class="ng-tns-c65-31 ui-dropdown ui-widget ui-state-default ui-corner-all"]').click()
await page.click('[aria-label="AC First Class (1A) "]');
///Verify the 'Categories' dropdown field 
...
//To verify the Book Ticket details section with valid data
 //Verify the 'From' field textbox
 await page.fill('[class="ng-tns-c57-28 ui-inputtext ui-widget ui-state-default ui-corner-all ui-autocomplete-input ng-star-inserted"]', 'THIRUVARUR JN - TVR');
 await page.click('[class="col-xs-12 loginhead hidden-xs"]');

 //Verify the 'To' field textbox

 await page.fill('[class="ng-tns-c57-29 ui-inputtext ui-widget ui-state-default ui-corner-all ui-autocomplete-input ng-star-inserted"]', 'CHENNAI EGMORE - MS');
 await page.click('[class="col-xs-12 loginhead hidden-xs"]');
...
// await page.click('[aria-label="LADIES"]');
 ...
 //page.locator('[class="search_btn train_Search"]', { hasText: 'Search' }).click() 
//To verify the Train List screen
//await page.locator('span.ui-button-text.ui-clickable', { hasText: 'OK' }).isVisible();
