...
await page.locator('.btn-title', { timeout: 40000 }).click();
    //Click on Services tab and check
    await page.locator('.navbar-nav > li:nth-of-type(1) > .nav-link').click();
        //Click Automation Testing
    await page.locator('a[href="https://www.qaoncloud.com/automation-testing-services"]', { timeout: 30000 }).click();
    await page.waitForTimeout(10000);
//Click Test Automation Services
await page.locator('a[href="https://www.qaoncloud.com/blog/how-to-select-right-test-cases-for-automation-testing"]', { timeout: 30000 }).click();
await page.waitForTimeout(10000);
