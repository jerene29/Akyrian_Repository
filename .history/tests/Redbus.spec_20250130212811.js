...
await expect(page.locator('[class="bpdp_list_title"]')).nth(1).toHaveText('BOARDING POINT');
await expect(page.locator('[class="bpdp_list_title"]')).nth(2).toHaveText('DROPPING POINT');
//Click Review
