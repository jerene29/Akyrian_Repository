...
//Verify 'User name' field textbox
await page.locator("[placeholder='User Name']", '', { timeout: 10000 })
await page.fill("[placeholder='User Name']", 'Divycccsffsdfsfdsdfa112314225436d');
//Verify 'User name' field textbox
await page.fill("[placeholder='Password']", '')
...
const Message = await page.locator('[class="ui-dialog-title ng-tns-c19-24 ng-star-inserted"]');
await expect(Message).toBeVisible();
await expect(Message).toHaveText('Confirmation');
const Message1 = await page.locator('.pan-boder > .col-xs-12 > [_ngcontent-ibf-c53]');
