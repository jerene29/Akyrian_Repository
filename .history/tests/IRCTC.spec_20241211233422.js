...
//Verify the 'From' field textbox
await page.fill('[class="ng-tns-c57-60 ui-inputtext ui-widget ui-state-default ui-corner-all ui-autocomplete-input ng-star-inserted"]', ' ');
//Verify the 'To' field textbox
await page.fill('[class="ng-tns-c57-61 ui-inputtext ui-widget ui-state-default ui-corner-all ui-autocomplete-input ng-star-inserted"]', ' ');
//Verify the 'Date' field with datepicker[
await page.locator('[class="ng-tns-c58-10 ui-inputtext ui-widget ui-state-default ui-corner-all ng-star-inserted"]').click()
