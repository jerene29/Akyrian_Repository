...
//To verify the Book Ticket details section with valid data
 ...
 await page.click('[class="ng-tns-c57-29 ng-star-inserted ui-autocomplete-list-item ui-corner-all:has-text(" THIRUVARUR JN - TVR ")"]');
 ...
 await page.click('[class="ng-tns-c57-30 ng-star-inserted ui-autocomplete-list-item ui-corner-all:has-text(" ➨ CHENNAI EGMORE - MS "]');
