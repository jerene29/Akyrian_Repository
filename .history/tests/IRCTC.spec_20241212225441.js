...
await page.click('[class="ng-tns-c57-54 ui-inputtext ui-widget ui-state-default ui-corner-all ui-autocomplete-input ng-star-inserted"]');

// Now fill in the text
await page.fill('[class="ng-tns-c57-54 ui-inputtext ui-widget ui-state-default ui-corner-all ui-autocomplete-input ng-star-inserted"]', 'cvvv');
...
// Now fill in the text
await page.fill('[class="ng-tns-c57-55 ui-inputtext ui-widget ui-state-default ui-corner-all ui-autocomplete-input ng-star-inserted"]', 'cvvv');//Verify the 'To' field textbox
await page.click('[class="col-xs-12 loginhead hidden-xs"]');

//Verify the 'Date' field with datepicker[
await page.locator('[class="ng-tns-c58-56 ui-inputtext ui-widget ui-state-default ui-corner-all ng-star-inserted"]').click()

await page.click('.ui-state-default.ng-tns-c58-56.ng-star-inserted >> text=25');
//Verify the 'Classes' dropdown field 
await page.locator('[class="ng-tns-c65-57 ui-dropdown ui-widget ui-state-default ui-corner-all"]').click()
await page.click('[aria-label="AC First Class (1A) "]');
///Verify the 'Categories' dropdown field 
await page.locator('[class="ng-tns-c65-58 ui-dropdown ui-widget ui-state-default ui-corner-all"]').click()
await page.click('[aria-label="LADIES"]');
page.locator("[type='submit']").click() 

//To verify the Book Ticket details section with valid data
 //Verify the 'From' field textbox
 await page.fill('[class="ng-tns-c57-54 ui-inputtext ui-widget ui-state-default ui-corner-all ui-autocomplete-input ng-star-inserted"]', 'THIRUVARUR JN - TVR');
 await page.click('[class="col-xs-12 loginhead hidden-xs"]');

 //Verify the 'To' field textbox

 await page.fill('[class="ng-tns-c57-55 ui-inputtext ui-widget ui-state-default ui-corner-all ui-autocomplete-input ng-star-inserted"]', 'CHENNAI EGMORE - MS');
 await page.click('[class="col-xs-12 loginhead hidden-xs"]');
