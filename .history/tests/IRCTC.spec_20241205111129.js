...
const buttons = page.locator('button.search_btn.train_Search');

// Ensure that the second button exists and click it
const buttonCount = await buttons.count();
if (buttonCount > 1) {
  console.log('Clicking the second "SIGN IN" button...');
  await buttons.nth(1).click({ force: true }); // Click the second button
} else {
  console.log('Less than 2 buttons found');
}
