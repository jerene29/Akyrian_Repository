...
await page.locator('[data-cy="visit-cm31qz0990dhkigpbpkpgy2p5"]')
    ...
    await page.locator('[data-cy="sourceQuestionTab"]').waitFor({ state: 'attached' }); // Ensure it's attached to the DOM
    await page.locator('[data-cy="sourceQuestionTab"]').waitFor({ state: 'visible' }); // Ensure it's visible
    await page.locator('[data-cy="sourceQuestionTab"]').waitFor({ state: 'enabled' }); // Ensure it's interactable
...
await page.locator('[data-cy="upload-sc-button"]').waitFor({ state: 'visible' });
