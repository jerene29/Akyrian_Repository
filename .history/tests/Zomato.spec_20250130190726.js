...
//await page.waitForSelector('[aria-label="Continue with Email"]', { state: 'visible' }, { timeout: 60000 }); // Wait for the element to be visible
//await page.click('[aria-label="Continue with Email"]');  // Then click it

await page.fill('[class="sc-1yzxt5f-9 dFuFxh"]',"divyarajagopal94@gmail.com");
