...
test('Login to the Portal and login as Source Capture User',async ({ page }) => {
    ...
    await page.locator('#cm2bkvinn0ag5vx8ae9kmvs0b-selectable-patient').waitFor({ state: 'visible' });

    await page.locator('#cm2bkvinn0ag5vx8ae9kmvs0b-selectable-patient')
...
await page.locator('[data-cy="visit-cm31qz0990dhkigpbpkpgy2p5"]')
    ...
    await page.locator('[data-cy="sourceQuestionTab"]').waitFor({ state: 'visible', timeout: 60000 }).click(); // 60 seconds timeout
