...
test('Check the Amazon portal home page', async ({ page }) => {
  ...
  const errorMessage = await page.locator('#auth-email-invalid-claim-alert .a-alert-content');
  await expect(errorMessage).toBeVisible();
  await expect(errorMessage).toHaveText('Wrong or Invalid email address or mobile phone number. Please correct and try again.')
