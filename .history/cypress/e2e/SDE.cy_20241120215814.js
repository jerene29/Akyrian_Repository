...
const textBoundingBox = {
  topLeftX: 249.046875,    // X coordinate for the top-left corner of the text area
  topLeftY: 106.0703125,    // Y coordinate for the top-left corner of the text area
  bottomRightX: 507.046875, // X coordinate for the bottom-right corner of the text area
  bottomRightY: 127.0703125, // Y coordinate for the bottom-right corner of the text area
};
