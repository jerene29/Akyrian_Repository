...
//Check VIew
cy.get('[data-cy="detail-view"]').contains("Detail View")
cy.get('[data-cy="grid-view"]').contains("Grid View")
...
cy.dragAndDrop(
  ...
  cy.get('[data-cy="add-new-question-page"]')
    .find('[data-cy="add-new-question-page"]', { timeout: 10000 })  // Wait for the element with increased timeout
...
cy.get('[class="ant-tabs-tab"]').click()
cy.wait(20000)
cy.get('[class="QuestionCanvas__MainContainer-bSeVBC lisQp"]')
  .scrollTo('bottom'); 
cy.dragAndDrop(
