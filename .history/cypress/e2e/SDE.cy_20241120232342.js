...
const textBoundingBox = {
  topLeftX: 1014,    // X coordinate for the top-left corner of the text area
  topLeftY: 446,    // Y coordinate for the top-left corner of the text area
  bottomRightX: 1098, // X coordinate for the bottom-right corner of the text area
  bottomRightY: 470, // Y coordinate for the bottom-right corner of the text area
};
