...
const startX = 232;  // Start X at canvas coords (36, 496)
const startY = 167; // Start Y at canvas coords (36, 496)

// End point after drag (canvas coords)
const endX = 328;   // End X at canvas coords (376, 436)
const endY = 192;   // End Y at canvas coords (376, 436)
