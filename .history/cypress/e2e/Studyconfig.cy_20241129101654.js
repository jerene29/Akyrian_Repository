...
import StudyConfig from "../support/Pageobjects/Studyconfig"
...
//CLick visit
StudyConfig.Visit_Name_1.contains("Visit_01").click()
//Check VIew
...
cy.dragAndDrop(
  ...
  cy.get('[data-cy="add-new-question-page"]')
    .find('[data-cy="question-input-container"]', { timeout: 30000 })  // Wait for the element with increased timeout
...
it.only("Login as StudyConfig user and Delete the Question", () => {
  cy.AkyrianSDELogin_studyconfig(email,password)
