...
const textBoundingBox = {
  topLeftX: 255.046875,    // X coordinate for the top-left corner of the text area
  topLeftY: 85.0703125,    // Y coordinate for the top-left corner of the text area
  bottomRightX: 507.046875, // X coordinate for the bottom-right corner of the text area
  bottomRightY: 120.0703125, // Y coordinate for the bottom-right corner of the text area
};
