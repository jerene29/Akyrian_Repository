...
it.only("Login to the Portal and login as Snippet Assessment", () => {
    ...
    cy.get('[data-cy="question-cm2k034w30u2uvx8arcfess1p"] > [data-cy="question-card"]').contains("SDE basic questions : Gender").click()
    cy.wait(20000)
    ...
    cy.get('[data-cy="question-cm2k034w30u2uvx8arcfess1p"] > [data-cy="question-card"]').contains("SDE basic questions : Gender")
