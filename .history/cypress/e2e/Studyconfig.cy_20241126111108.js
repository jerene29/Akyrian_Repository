...
cy.dragAndDrop(
    ...
    ".EmptyQuestion__Container-gQdEUg",
...
//Click Library
cy.get('[class="ant-tabs-tab"]',{ timeout:30000 }).click()
  ...
  //cy.get('[name="attr-noSCNeeded"]').click()
  cy.get('[data-cy="short-question-input-14"',{ timeout:40000 }).click( {force: true}).type("Numeric Question")
  cy.get('[data-cy="long-question-input-14"]',{ timeout:30000 }).click( {force: true}).type("Numeric Question") .invoke('text').as('Q3')
  cy.get('[data-cy="long-question-input-14"]',{ timeout:30000 }).then(($text1) => {
    const Q3 = $text1.text()
  ...
  cy.get('[data-cy="long-question-input-16"]').click( {force: true}).type("ZXZXX").invoke('text').as('Q2')
  cy.get('[data-cy="long-question-input-16"]').then(($text1) => {
    const Q2 = $text1.text()
    cy.get('[data-cy="long-question-input-16"]').should('contain', Q2)
