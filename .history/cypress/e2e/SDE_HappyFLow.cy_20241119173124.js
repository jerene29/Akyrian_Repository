...
cy.get('[data-cy="UNATTACHED"]', { timeout: 40000 }).click()
...
cy.get("[data-cy='reattach']", { timeout: 40000 }).click()
cy.get('[data-cy="upload-sc-button"]', { timeout: 30000 }).click()
...
cy.get('[data-cy="continue-to-suggestion-button"]', { timeout: 10000 }).click()
cy.get('[data-cy="confirm-redact-button"]', { timeout: 30000 }).click()
cy.get('[data-cy="right-chip-Allergies-AT"]', { timeout: 40000 }).click()
...
cy.get("[data-cy='reattach']", { timeout: 30000 }).click()
cy.get('[data-cy="upload-sc-button"]', { timeout: 30000 }).click()
...
cy.get('[data-cy="right-chip-BloodPressureAT"]', { timeout: 50000 }).click()
...
cy.get('[data-cy="confirm-redact-button"]', { timeout: 30000 }).click()
//cy.get('[data-cy="right-chip-Allergies-AT"]').click()
cy.get('[data-cy="right-chip-AgeAT"]', { timeout: 40000 }).click()
