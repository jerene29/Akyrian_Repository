...
const textBoundingBox = {
  topLeftX: 169,    // X coordinate for the top-left corner of the text area
  topLeftY: 120,    // Y coordinate for the top-left corner of the text area
  bottomRightX: 345, // X coordinate for the bottom-right corner of the text area
  bottomRightY: 153, // Y coordinate for the bottom-right corner of the text area
};
