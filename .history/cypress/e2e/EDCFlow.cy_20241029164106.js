...
//Login Page
describe('EDC Flow', function() {
it("Login to the Portal and login as SC User", () => {
...
cy.get('[class="Text__StyledText-fcSGOX liUSLx adjust-version mb-0.5"]').contains("v.4.b")
...
cy.get('[class="Text__StyledText-fcSGOX kNgNur ml-3"]').contains("Edit Profile").should('be.visible')
cy.get('[data-cy="edit-profile-change-password-button"]').contains("Change Password")
...
//Check Links
cy.get('[data-cy="todolist-UNFILLED"]').should('be.visible')
//Check Search fields
...
cy.get('[data-cy="question-filter-count"]').contains("6")
cy.get('[data-cy="question-title-cm226tq6o0kz814ev5hs86itn"]').contains("Indication/Diagnosis:(T)").should('exist')
cy.get('[data-cy="question-title-cm226tqch0kzg14evi17ksxwu"]').contains("Start Date Medication:").should('exist')
cy.get('[data-cy="question-title-cm226tqxy0l0z14ev4ggwb5pe"]').contains("What are the dosage, frequency, duration, and mode of delivery?(N)").should('exist')
cy.get('[data-cy="question-title-cm226tqgo0kzo14evx8adxtw7"]').contains("Date of Service").should('exist')
...
cy.get('[data-cy="question-filter-count"]').contains("1")
...
//Check the Change answer
cy.get('[data-cy="FILLED"]').click()
cy.get('[data-cy="change-answer-action-icon-cm226tqch0kzg14evi17ksxwu"]').click({ force: true })
cy.get('[class="ant-picker-input"]').eq(0).click()
...
/*
//click visit 2
cy.get('[data-cy="visit-cm24cnm8k02myvx8axc1nvmwr"]').contains("AutomationSDE").click()
...
it("Login to the Portal and login as SA User-Approve/Reject", () => {
