...
const startX = 36;  // Start X at canvas coords (36, 496)
const startY = 496; // Start Y at canvas coords (36, 496)

// End point after drag (canvas coords)
const endX = 376;   // End X at canvas coords (376, 436)
const endY = 436;   // End Y at canvas coords (376, 436)
