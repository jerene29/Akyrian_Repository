...
const startX = 169;  // Start X at canvas coords (36, 496)
const startY = 120; // Start Y at canvas coords (36, 496)

// End point after drag (canvas coords)
const endX = 345;   // End X at canvas coords (376, 436)
const endY = 153;   // End Y at canvas coords (376, 436)
