...
const textBoundingBox = {
  topLeftX: 241.046875,    // X coordinate for the top-left corner of the text area
  topLeftY: 177.0703125,    // Y coordinate for the top-left corner of the text area
  bottomRightX: 507.046875, // X coordinate for the bottom-right corner of the text area
  bottomRightY: 205.0703125, // Y coordinate for the bottom-right corner of the text area
};
