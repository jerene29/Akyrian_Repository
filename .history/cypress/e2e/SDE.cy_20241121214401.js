...
const textBoundingBox = {
  topLeftX:384.046875,    // X coordinate for the top-left corner of the text area
  topLeftY: 351.0703125,    // Y coordinate for the top-left corner of the text area
  bottomRightX: 510.046875, // X coordinate for the bottom-right corner of the text area
  bottomRightY: 378.0703125, // Y coordinate for the bottom-right corner of the text area
};

// Use Cypress to trigger the crop action
cy.get('[style="cursor: crosshair;"] > .konvajs-content > canvas')
  .trigger('mousedown', { clientX: textBoundingBox.topLeftX, clientY: textBoundingBox.topLeftY })  // Start crop at top-left of the text
  .trigger('mousemove', { clientX: textBoundingBox.bottomRightX, clientY: textBoundingBox.bottomRightY })  // Drag to bottom-right of the text
  .trigger('mouseup');  // End crop action

// Take a screenshot of the selected area
cy.screenshot('text_crop');  
/*
// Canvas Coordinates (from the console logs)
const startX = 354;  // Start X at canvas coords (36, 496)
const startY = 257; // Start Y at canvas coords (36, 496)

// End point after drag (canvas coords)
const endX = 530;   // End X at canvas coords (376, 436)
const endY = 290;   // End Y at canvas coords (376, 436)
