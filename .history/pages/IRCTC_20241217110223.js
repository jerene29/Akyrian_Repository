...
class IRCTCPage {
    ...
    async open() {
        await this.page.goto('https://www.irctc.co.in/nget/train-search', { timeout: 500000 });
    ...
    async checkLoginPageElements() {
        await expect(this.page.locator(this.loginLink).nth(0)).toBeVisible();
        await expect(this.page.locator(this.irctcExclusiveLink).nth(0)).toBeVisible();
