const { test, expect } = require('@playwright/test');
    ...
    test('Login to the Portal and login as Source Capture User', async ({ page }) => {
        ...
        // Visit the portal
        await page.goto('https://qa.akyrian.com/', { timeout: 60000 });
        // Login action
...
await page.locator('[class="Text__StyledText-fcSGOX gSpvOG sider-patient-name"]').filter({ hasText: 'QA_AU-02' }).click();
