...
const redactionCoords = [
  { x: 10, y: 10, width: 50, height: 50 },          // Adjust these values as needed
];
cy.task('redactImage', {
  imagePath: 'SCImage.png', 
  redactionCoords
}).then(() => {
  // Continue with your tests after redaction
  cy.log('Image redacted successfully.');
});

// Optionally, add assertions here to verify the redaction
