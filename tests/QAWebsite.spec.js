...
await page.locator('.navbar-nav > li:nth-of-type(2) > .nav-link', { timeout: 40000 }).click();
//Click Mobile App Testing
await page.locator('[href="https://www.qaoncloud.com/mobile-app-testing-services"]', { timeout: 40000 }).click();
await expect(page).toHaveURL('https://www.qaoncloud.com/mobile-app-testing-services', { timeout: 30000 }); // Replace with expected URL
//Click Web App Testing
await page.locator('.navbar-nav > li:nth-of-type(2) > .nav-link', { timeout: 40000 }).click();

await page.locator('a[href="https://www.qaoncloud.com/web-app-testing-services"]', { timeout: 40000 }).click();
await expect(page).toHaveURL('https://www.qaoncloud.com/web-app-testing-services', { timeout: 30000 });
//Click Game Testing
await page.locator('.navbar-nav > li:nth-of-type(2) > .nav-link', { timeout: 40000 }).click();

await page.locator('a[href="https://www.qaoncloud.com/game-testing-services"]', { timeout: 40000 }).click();
await expect(page).toHaveURL('https://www.qaoncloud.com/game-testing-services', { timeout: 30000 });
//Click Cross Platform Testing
await page.locator('.navbar-nav > li:nth-of-type(2) > .nav-link', { timeout: 40000 }).click();

await page.locator('a[href="https://www.qaoncloud.com/cross-platform-testing-services"]', { timeout: 40000 }).click();
await expect(page).toHaveURL('https://www.qaoncloud.com/cross-platform-testing-services', { timeout: 40000 });
//Click Cross Platform Testing
await page.locator('.navbar-nav > li:nth-of-type(2) > .nav-link', { timeout: 40000 }).click();

await page.locator('a[href="https://www.qaoncloud.com/cross-platform-testing-services"]', { timeout: 40000 }).click();
await expect(page).toHaveURL('https://www.qaoncloud.com/cross-platform-testing-services', { timeout: 30000 });

//Click Cross Browser Testing
await page.locator('.navbar-nav > li:nth-of-type(2) > .nav-link', { timeout: 40000 }).click();

await page.locator('a[href="https://www.qaoncloud.com/cross-browser-testing-services"]', { timeout: 40000 }).click();
await expect(page).toHaveURL('https://www.qaoncloud.com/cross-browser-testing-services', { timeout: 30000 });
//Click Smart Tv Testing
await page.locator('.navbar-nav > li:nth-of-type(2) > .nav-link', { timeout: 40000 }).click();

await page.locator('a[href="https://www.qaoncloud.com/smart-tv-app-testing-services"]', { timeout: 40000 }).click();
await expect(page).toHaveURL('https://www.qaoncloud.com/smart-tv-app-testing-services', { timeout: 30000 });


//Click Industries Link

await page.locator('.navbar-nav > li:nth-of-type(3) > .nav-link', { timeout: 40000 }).click();
//Click  Banking & Financial Services
await page.locator('a[href="https://www.qaoncloud.com/fintech-testing-services"]', { timeout: 40000 }).click();
await expect(page).toHaveURL('https://www.qaoncloud.com/fintech-testing-services', { timeout: 30000 });
//Click   Communications
await page.locator('.navbar-nav > li:nth-of-type(3) > .nav-link', { timeout: 40000 }).click();

await page.locator('a[href="https://www.qaoncloud.com/telecom-testing-services"]', { timeout: 40000 }).click();
await expect(page).toHaveURL('https://www.qaoncloud.com/telecom-testing-services', { timeout: 30000 });
//Click   Event Management
await page.locator('.navbar-nav > li:nth-of-type(3) > .nav-link', { timeout: 40000 }).click();

await page.locator('a[href="https://www.qaoncloud.com/event-management-software-testing-services"]', { timeout: 50000 }).click();
await expect(page).toHaveURL('https://www.qaoncloud.com/event-management-software-testing-services', { timeout: 50000 });

//Click   E-Commerce
await page.locator('.navbar-nav > li:nth-of-type(3) > .nav-link', { timeout: 50000 }).click();

await page.locator('a[href="https://www.qaoncloud.com/e-commerce-testing-services"]', { timeout: 50000 }).click();
await expect(page).toHaveURL('https://www.qaoncloud.com/e-commerce-testing-services', { timeout: 50000 });
//Click   Artificial Intelligence
await page.locator('.navbar-nav > li:nth-of-type(3) > .nav-link', { timeout: 50000 }).click();

await page.locator('a[href="https://www.qaoncloud.com/ai-testing-services"]', { timeout: 50000 }).click();
await expect(page).toHaveURL('https://www.qaoncloud.com/ai-testing-services', { timeout: 50000 });
//Click Insights Link

await page.locator('.navbar-nav > li:nth-of-type(4) > .nav-link', { timeout: 50000 }).click();
//Click  Blogs
await page.locator('a[href="https://www.qaoncloud.com/blog-trending-posts"]', { timeout: 50000 }).click();
await expect(page).toHaveURL('https://www.qaoncloud.com/blog-trending-posts', { timeout: 50000 });
//Click Casestudies
await page.locator('.navbar-nav > li:nth-of-type(4) > .nav-link', { timeout:50000 }).click();

await page.locator('a[href="https://www.qaoncloud.com/case-study"]', { timeout: 50000 }).click();
await expect(page).toHaveURL('https://www.qaoncloud.com/case-study', { timeout: 50000 });
//Click FAQs
await page.locator('.navbar-nav > li:nth-of-type(4) > .nav-link', { timeout: 50000 }).click();

await page.locator('a[href="https://www.qaoncloud.com/faq"]', { timeout: 50000 }).click();
await expect(page).toHaveURL('https://www.qaoncloud.com/faq', { timeout: 50000 });
//Click Testimonials
await page.locator('.navbar-nav > li:nth-of-type(4) > .nav-link', { timeout: 70000 }).click();

await page.locator('a[href="https://www.qaoncloud.com/testimonial"]', { timeout: 70000 }).click();
await expect(page).toHaveURL('https://www.qaoncloud.com/testimonial', { timeout: 60000 });
})